async function data() {
  ...
  city = city.filter((el) => el.name == cityName);
  ...
  for (i = 0; i < 3; i++) {
    ...
    document.getElementById(
      "city"
    ).innerHTML = `Find Hotels in ${city[i].name},India`;
    document.getElementById(
      "hotel-date"
    ).innerHTML = `Check ${city[i].name} Hotel price`;
    ...
    document.getElementById(
      "hotel-price1"
    ).innerHTML = `${city[i].hotels[0].price} $`;
    document.getElementById(
      "hotel-price2"
    ).innerHTML = `${city[i].hotels[1].price} $`;
    document.getElementById(
      "hotel-price3"
    ).innerHTML = `${city[i].hotels[2].price} $`;
